...
def load_data(input_directory, target_directory, target_feature):
    ...
    for input_filename in os.listdir(input_directory):
        if input_filename.endswith(".csv") and target_feature in input_filename and 'SUB17_on' not in input_filename:
            ...
            try:
                ...
                # print('input_numerical_data1', input_numerical_data)
                input_numerical_data.dropna(inplace=True)
                # print('input_numerical_data2', input_numerical_data)
                input_numerical_data.reset_index(drop=True, inplace=True)
                # print('input_numerical_data3', input_numerical_data)
                ...
                # print('input_numerical_data4', input_numerical_data)
                ...
                if related_target is not None:
                    ...
                    # print('input_numerical_data5', input_numerical_data)
                all_data = pd.concat([all_data, input_numerical_data]).reset_index(drop=True)
    ...
    # print('all_data9', all_data)
    all_data = all_data_trimmed.copy()
    # print('all_data10', all_data)
    ...
    # print('training_all_data', training_all_data)
